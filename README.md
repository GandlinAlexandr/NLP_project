...
Так как парсинг может занимать десятки часов, среди файлов проекта также присутствует готовый датафрейм, полученный с помощью данного парсера. Структура датафрейма:
