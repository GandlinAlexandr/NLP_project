...
async def cmd_start(message: types.Message):
    await message.answer(
        ...
        "(например, '29.03.2023' или '03.2023'). "
        "И, если хотите, задайте произвольную тему через пробел от даты. "
        "Например: '29.03.2023 Изменение климата'."
    )
...
async def cmd_help(message: types.Message):
    await message.reply(
        ...
        "написанную в формате ДД.ММ.ГГГГ или ММ.ГГГГ (например, '29.03.2023' или "
        ...
        "PS: запрос статей за месяц может обрабатываться несколько минут. "
        "В зависимости от количества статей в месяце."
    )
